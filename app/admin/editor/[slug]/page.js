...
const widgetTemplates = {
  ...
  carousel: '<div data-ce-widget="carousel" data-ce-label="Carrossel (linha horizontal)" style="display:grid;grid-auto-flow:column;grid-auto-columns:minmax(220px,1fr);gap:16px;width:100%;overflow-x:auto;"><img src="/assets/logo-letra.svg" alt="" style="display:block;width:100%;aspect-ratio:4/3;object-fit:cover;" /><img src="/assets/logo-letra.svg" alt="" style="display:block;width:100%;aspect-ratio:4/3;object-fit:cover;" /><img src="/assets/logo-letra.svg" alt="" style="display:block;width:100%;aspect-ratio:4/3;object-fit:cover;" /></div>',
