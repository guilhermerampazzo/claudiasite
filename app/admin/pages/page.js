      ...
      <main className="admin-main">
        ...
        <section className="site-chrome-section dashboard-section">
          ...
          <form className="chrome-editor" onSubmit={saveSettings}>
            ...
            {activeChromeTab === "footer" ? <div className="chrome-panel"><div className="chrome-preview footer-preview"><div className="header-brand-preview"><img src="/assets/logo-icone.svg" alt="" /><img src="/assets/logo-letra.svg" alt="Casa Estampa Interiores" /></div><small>{settings.footer.site} | {settings.footer.contact}</small></div><div className="chrome-fields"><label className="field"><span>Nome legal da marca</span><input value={settings.footer.brand} onChange={(event) => updateFooter("brand", event.target.value)} /></label><label className="field"><span>Site</span><input value={settings.footer.site} onChange={(event) => updateFooter("site", event.target.value)} /></label><label className="field"><span>Contato</span><input value={settings.footer.contact} onChange={(event) => updateFooter("contact", event.target.value)} /></label></div></div> : null}
