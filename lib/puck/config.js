...
function Hero({ bgImage, bgImageMobile, logoImage, showTitle, showSub, label, title, highlight, sub, primaryLabel, primaryHref, secondaryLabel, secondaryHref }) {
  return (
    <section className="hero">
      {bgImageMobile ? <style>{`@media(max-width:768px){.hero{background-image:url('${bgImageMobile}')!important;background-size:cover!important;background-position:center center!important;}}`}</style> : null}
