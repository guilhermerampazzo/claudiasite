...
function escapeHtml(value) {
  return decodeEntities(value).replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;");
}
...
function catalogStyles() {
  ...
  .ce-catalog-embedded .ce-category-card{background:#171208;color:#e8dcc0;border-color:rgba(194,165,122,.28)}
