...
function buildGlobalCss(settings) {
  const rules = [];
  const root = [];
  rules.push(".navbar-logo .site-logo-icon{width:42px!important;height:42px!important;object-fit:contain;flex:0 0 42px;}");
  rules.push(".navbar-logo .site-logo-lettering{width:auto!important;height:58px!important;max-width:240px;object-fit:contain;}");
  rules.push("@media(max-width:700px){.navbar-logo .site-logo-icon{width:32px!important;height:32px!important;flex-basis:32px;}.navbar-logo .site-logo-lettering{height:42px!important;max-width:140px;}}");
