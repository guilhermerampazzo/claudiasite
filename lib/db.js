...
export function buildGlobalCss(settings) {
  ...
  rules.push(".carousel-nav,.inst-nav,.insp-nav,.gal-nav,.gal-arrow,#galPrev2,#galNext2{display:none!important;}");
   ...
   // Desktop/tablet: slides do carrossel com largura propia (importacao trouxe 240px inline, ficando minusculos no PC)
   rules.push("@media(min-width:769px){.ce-global-carousel-track>*{width:clamp(300px,28vw,460px)!important;}}");
  ...
  rules.push(".caso-logo-img img{filter:brightness(0) invert(1)!important;opacity:.92!important;height:56px!important;width:auto!important;max-width:none!important;max-height:none!important;object-fit:contain!important;}");
