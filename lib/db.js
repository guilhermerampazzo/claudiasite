    ...
    <div class="ce-footer-main">
      <div class="ce-footer-brand">
        <a href="${escapeAttribute(settings.header.logoHref)}" aria-label="Página inicial Casa Estampa">
          <img class="ce-footer-icon" src="${escapeAttribute(settings.header.iconSrc)}" alt="">
          <img class="ce-footer-lettering" src="${escapeAttribute(settings.header.logoSrc)}" alt="${escapeAttribute(settings.footer.brand)}">
        </a>
        <p>${escapeHtml(settings.footer.subtitle)}</p>
      </div>
