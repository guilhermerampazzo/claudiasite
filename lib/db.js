...
export function buildGlobalCss(settings) {
  ...
  rules.push("@media(max-width:768px){body .caso-logo-img.caso-logo-claro{min-width:220px!important;min-height:128px!important;padding:16px 24px!important;}body .caso-logo-img.caso-logo-claro img{height:72px!important;max-height:72px!important;max-width:230px!important;}}");
