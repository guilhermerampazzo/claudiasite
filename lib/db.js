...
export function buildGlobalCss(settings) {
  ...
  rules.push(".caso-logo img,.caso-logo-img img{height:64px!important;max-height:64px!important;max-width:210px!important;}");
  rules.push("@media(max-width:768px){.caso-logo{padding:16px 22px!important;}.caso-logo img,.caso-logo-img img{height:60px!important;max-height:60px!important;max-width:200px!important;}}");
