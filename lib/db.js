...
export function buildGlobalCss(settings) {
  ...
  rules.push("html{overflow-x:clip!important;}");
  rules.push("body{padding-top:104px!important;display:block!important;flex-flow:column nowrap!important;overflow:visible!important;overflow-x:clip!important;}");
  rules.push("body.ce-global-carousel, body.ce-global-carousel-track, html.ce-global-carousel, html.ce-global-carousel-track{display:block!important;flex-flow:column nowrap!important;overflow:visible!important;overflow-x:clip!important;transform:none!important;}");
  ...
  // FAQ fechado por padrão com "+" nas perguntas (pedido cliente 11:27) — reverte o aberto anterior
  rules.push(".ce-exact-page .elementor-toggle .elementor-tab-content{display:none!important;padding:0 18px 0!important;overflow:hidden!important;}.ce-exact-page .elementor-toggle .elementor-tab-title.elementor-active + .elementor-tab-content,.ce-exact-page .elementor-toggle .elementor-tab-title[aria-expanded=\"true\"] + .elementor-tab-content{display:block!important;padding:0 18px 19px!important;}.ce-exact-page .elementor-toggle .elementor-tab-title{display:flex!important;align-items:center!important;gap:12px!important;cursor:pointer!important;}.ce-exact-page .elementor-toggle .elementor-toggle-icon{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:22px!important;height:22px!important;border:1px solid rgba(194,165,122,.35)!important;color:var(--fendi,#c2a57a)!important;flex:0 0 22px!important;}.ce-exact-page .elementor-toggle .elementor-toggle-icon i{font-size:14px!important;transition:transform .2s!important;display:block!important;}.ce-exact-page .elementor-toggle .elementor-tab-title.elementor-active .elementor-toggle-icon i{transform:rotate(45deg)!important;} .faq-item .faq-a{max-height:0!important;overflow:hidden!important;padding-bottom:0!important;transition:max-height .35s ease!important;} .faq-item.open .faq-a{max-height:400px!important;padding-bottom:18px!important;} .faq-item .faq-icon{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:22px!important;height:22px!important;border:1px solid rgba(194,165,122,.35)!important;color:var(--fendi,#c2a57a)!important;} .faq-item .faq-q i{transition:transform .2s!important;display:block!important;} .faq-item.open .faq-q i{transform:rotate(45deg)!important;} .faq-item .faq-q[aria-expanded=\"true\"]{color:var(--fendi,#c2a57a)!important;}");
  ...
  return `(() => {
    ...
    function boot(){
      ...
      function setActive(active){
        pills.forEach(p=>p.classList.toggle('active', p===active));
      }
...
function buildCalcFixScript() {
  return `(() => {
    function boot(){
      ...
      const btn = document.getElementById('ceCalcBtn');
      const out = document.getElementById('ceCalcResultado');
      const txt = document.getElementById('ceCalcTexto');
      ...
      function calc(){
        if(typeof ceCalcularRolos === 'function') ceCalcularRolos();
        else if(typeof calcularRolos === 'function') calcularRolos();
        if(out && out.style.display==='none') out.style.display='block';
        if(simInline && simInline.style.display==='none') simInline.style.display='flex';
        if(simVazio && out && out.style.display==='block') simVazio.style.display='none';
      ...
      if(form){
        ...
        form.addEventListener('keydown', (e)=>{ if(e.key==='Enter'){ e.preventDefault(); calc(); }});
      }
    }
    if(document.readyState==='loading') document.addEventListener('DOMContentLoaded', boot, {once:true});
    else boot();
