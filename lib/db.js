...
export function buildGlobalCss(settings) {
  ...
  rules.push(".elementor > section.elementor-top-section:first-of-type .elementor-widget-heading,.elementor > section.elementor-top-section:first-of-type .elementor-widget-text-editor{display:none!important;}");
