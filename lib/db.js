...
export function buildGlobalCss(settings) {
  ...
  rules.push("@media(max-width:768px){body .caso-logo-img.caso-logo-claro{min-width:200px!important;min-height:104px!important;padding:14px 20px!important;}body .caso-logo-img.caso-logo-claro img{height:52px!important;max-height:52px!important;max-width:200px!important;}}");
  rules.push("@media(max-width:768px){body .caso-logo .caso-logo-img.caso-logo-claro{min-width:200px!important;min-height:104px!important;padding:14px 20px!important;}body .caso-logo .caso-logo-img.caso-logo-claro img{height:52px!important;max-height:52px!important;max-width:200px!important;}}");
