...
export function buildGlobalCss(settings) {
  ...
  // C) Como funciona / processo: nunca cortar o nº4 — trilha com scroll horizontal + snap no mobile
  rules.push("@media(max-width:768px){.proc-steps,.processo .steps{overflow-x:auto!important;overflow-y:visible!important;scroll-snap-type:x mandatory!important;-webkit-overflow-scrolling:touch!important;scrollbar-width:none!important;flex-wrap:nowrap!important;padding-bottom:14px!important;}.proc-steps::-webkit-scrollbar,.processo .steps::-webkit-scrollbar{display:none!important;}.proc-steps::before,.processo .steps::before{display:none!important;}.proc-step,.processo .step{flex:0 0 64%!important;min-width:0!important;scroll-snap-align:center!important;}}");
  ...
  // F) Logos empresas: fundo claro uniforme, sem filtro branco, Fairmont no mesmo tamanho
  rules.push(".caso-logo{width:auto!important;height:auto!important;background:#f5efe2!important;border:1px solid rgba(194,165,122,.4)!important;border-radius:8px!important;padding:12px 20px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;box-shadow:0 4px 14px rgba(0,0,0,.18)!important;}");
  rules.push(".caso-logo .caso-logo-img{background:#f5efe2!important;border:none!important;border-radius:0!important;padding:0!important;width:auto!important;height:auto!important;box-shadow:none!important;display:flex!important;align-items:center!important;justify-content:center!important;}");
  rules.push(".caso-logo img,.caso-logo-img img{filter:none!important;opacity:1!important;height:52px!important;width:auto!important;max-width:190px!important;max-height:52px!important;object-fit:contain!important;}");
  rules.push("@media(max-width:768px){.caso-logo img,.caso-logo-img img{height:44px!important;max-height:44px!important;max-width:160px!important;}}");
  rules.push(".caso-logo-placeholder{background:#f5efe2!important;color:#2a2218!important;border-radius:4px!important;padding:10px 16px!important;}");
